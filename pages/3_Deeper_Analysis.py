...
user_input = st.text_input("Enter languages you want to explore and hit 'Enter' when done")
...
if user_input:
    ...
    #st.write(f"You entered: {user_selected_langs}")
...
# ---------------------------------------------  Plotting an Analysis section
   ...
   # st.write(len(data))
    ...
    st.write("Please enter some languages to begin!")